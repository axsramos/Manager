...
<div id="layoutAuthentication">
  <div id="layoutAuthentication_content"><main><div class="container"><div class="row justify-content-center"><div class="col-lg-5">
    <div class="card shadow-lg border-0 rounded-lg mt-5">
      ...
      <div class="card-body">
        <h4 class="text-center font-weight-light mb-2">Verifique seu e-mail</h4>
        <p class="small text-muted text-center mb-4">Informe o código enviado para continuar.</p>
        ...
        <form action="/Auth/Register" method="post">
          ...
          <div class="mb-3"><label for="inputVerificationCode">Código de verificação</label><input class="form-control" id="inputVerificationCode" name="inputVerificationCode" type="text" inputmode="numeric" pattern="[0-9]{6}" maxlength="6" autocomplete="one-time-code" required autofocus></div>
          <button class="btn btn-primary btn-block w-100" id="btnVerify" name="btnVerify" type="submit">Verificar código</button>
