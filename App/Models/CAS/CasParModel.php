...
use App\Metadata\CAS\CasParMD;
use App\Models\Traits\CrudOperationsTrait;

class CasParModel extends CasParMD
{
    ...
    {
        if (empty($this->att['CasParBlq'])) {
            $this->att['CasParBlq'] = 'N';
        }
        if ($this->att['CasParBlq'] == 'N') {
            $this->att['CasParBlqDtt'] = null;
        }
        if ($this->att['CasParBlq'] == 'S' && empty($this->att['CasParBlqDtt'])) {
            $this->att['CasParBlqDtt'] = $dtnow_str;
        }
    }
}
