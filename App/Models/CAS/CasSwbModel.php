...
class CasSwbModel extends CasSwbMD
{
    ...
    {
        if (empty($this->att['CasSwbBlq'])) {
            $this->att['CasSwbBlq'] = 'N';
        }
        if ($this->att['CasSwbBlq'] == 'N') {
            $this->att['CasSwbBlqDtt'] = null;
        }
        if ($this->att['CasSwbBlq'] == 'S' && empty($this->att['CasSwbBlqDtt'])) {
            $this->att['CasSwbBlqDtt'] = $dtnow_str;
        }
        if (empty($this->att['CasSwbIni'])) {
            $this->att['CasSwbIni'] = $dtnow_str;
        }
    }
}
