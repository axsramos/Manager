...
use App\Metadata\CAS\CasMnaMD;
use App\Models\Traits\CrudOperationsTrait;

class CasMnaModel extends CasMnaMD
{
    ...
    {
        if (empty($this->att['CasMnaBlq'])) {
            $this->att['CasMnaBlq'] = 'N';
        }
        if ($this->att['CasMnaBlq'] == 'N') {
            $this->att['CasMnaBlqDtt'] = null;
        }
        if ($this->att['CasMnaBlq'] == 'S' && empty($this->att['CasMnaBlqDtt'])) {
            $this->att['CasMnaBlqDtt'] = $dtnow_str;
        }
    }
}
