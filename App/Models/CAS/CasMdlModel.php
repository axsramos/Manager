...
use App\Metadata\CAS\CasMdlMD;
use App\Models\Traits\CrudOperationsTrait;
use PDO;

class CasMdlModel extends CasMdlMD
{
    ...
    {
        if (empty($this->att['CasMdlBlq'])) {
            $this->att['CasMdlBlq'] = 'N';
        }
        if ($this->att['CasMdlBlq'] == 'N') {
            $this->att['CasMdlBlqDtt'] = null;
        }
        if ($this->att['CasMdlBlq'] == 'S' && empty($this->att['CasMdlBlqDtt'])) {
            $this->att['CasMdlBlqDtt'] = $dtnow_str;
        }
    }
}
